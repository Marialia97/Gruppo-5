...
.method public static declared-synchronized parseCached(Lgnu/text/Path;)Lgnu/kawa/xml/KDocument;
    ...
    .prologue
    .line 85
    const-class v7, Lgnu/kawa/xml/Document;

    monitor-enter v7

    :goto_3
    :try_start_3
    sget-object v6, Lgnu/kawa/xml/Document$DocReference;->queue:Ljava/lang/ref/ReferenceQueue;
    ...
    .line 91
    sget-object v6, Lgnu/kawa/xml/Document;->docMapLocation:Lgnu/mapping/ThreadLocation;

    invoke-virtual {v6}, Lgnu/mapping/ThreadLocation;->getLocation()Lgnu/mapping/NamedLocation;
    ...
    invoke-virtual {v2, v6}, Lgnu/mapping/Location;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_2f
    :try_start_2f
    sget-object v6, Lgnu/kawa/xml/Document;->cache:Ljava/util/HashMap;
