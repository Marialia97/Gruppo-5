...
.method public static findAutoloadComments(Lgnu/kawa/lispexpr/LispReader;Ljava/lang/String;Lgnu/expr/ScopeExp;Lkawa/lang/Translator;)V
    ...
    .line 144
    .local v12, "lineStart":Z
    const-string v13, ";;;###autoload"
    ...
    .line 180
    .local v9, "form":Ljava/lang/Object;
    ...
    .line 193
    new-instance v18, Lkawa/lang/AutoloadProcedure;
    ...
    invoke-direct {v0, v15, v1, v2}, Lkawa/lang/AutoloadProcedure;-><init>(Ljava/lang/String;Ljava/lang/String;Lgnu/expr/Language;)V
    ...
    invoke-virtual {v0, v15, v1, v2}, Lgnu/expr/ScopeExp;->getDefine(Ljava/lang/Object;CLgnu/expr/Compilation;)Lgnu/expr/Declaration;
    ...
    invoke-direct {v8, v0}, Lgnu/expr/QuoteExp;-><init>(Ljava/lang/Object;)V

    .line 203
    .local v8, "ex":Lgnu/expr/Expression;
    const-wide/16 v20, 0x4000

    move-wide/from16 v0, v20

    invoke-virtual {v7, v0, v1}, Lgnu/expr/Declaration;->setFlag(J)V
    ...
    invoke-virtual {v7, v0}, Lgnu/expr/Declaration;->setProcedureDecl(Z)V

    .line 206
    sget-object v19, Lgnu/expr/Compilation;->typeProcedure:Lgnu/bytecode/ClassType;

    move-object/from16 v0, v19

    invoke-virtual {v7, v0}, Lgnu/expr/Declaration;->setType(Lgnu/bytecode/Type;)V

    .line 209
    .end local v6    # "command":Ljava/lang/String;
    .end local v7    # "decl":Lgnu/expr/Declaration;
    .end local v8    # "ex":Lgnu/expr/Expression;
    ...
    .line 165
    .end local v9    # "form":Ljava/lang/Object;
    :cond_9f
    invoke-virtual/range {p0 .. p0}, Lgnu/kawa/lispexpr/LispReader;->read()I
    ...
    .restart local v9    # "form":Ljava/lang/Object;
    ...
    const-string v21, "unsupported ;;;###autoload followed by: "
    ...
    .line 229
    .local v17, "skipped":Ljava/lang/Object;
...
.method public scanFile(Ljava/lang/String;Lgnu/expr/ScopeExp;Lkawa/lang/Translator;)Z
    ...
    :try_end_118
    .catch Ljava/lang/Exception; {:try_start_101 .. :try_end_118} :catch_11c
