...
.method public DownloadFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_end_4c
    .catch Ljava/io/IOException; {:try_start_43 .. :try_end_4c} :catch_81
    ...
    invoke-static {v12}, Lcom/google/appinventor/components/runtime/util/FileUtil;->openFile(Ljava/io/File;)Ljava/io/FileInputStream;
    ...
    :try_end_58
    .catchall {:try_start_4d .. :try_end_58} :catchall_ef
    ...
    :try_end_77
    .catchall {:try_start_58 .. :try_end_77} :catchall_ea
    ...
    :try_end_7d
    .catchall {:try_start_7a .. :try_end_7d} :catchall_ef
    ...
    :try_end_a8
    .catchall {:try_start_a1 .. :try_end_a8} :catchall_ea
    ...
    :try_end_ca
    .catchall {:try_start_ac .. :try_end_ca} :catchall_df
    ...
    :try_end_d7
    .catchall {:try_start_ce .. :try_end_d7} :catchall_ea

    .line 634
    :try_start_d7
    invoke-virtual {v9}, Ljava/io/InputStream;->close()V
    :try_end_da
    .catchall {:try_start_d7 .. :try_end_da} :catchall_ef
    ...
    throw v14
    :try_end_f4
    .catch Ljava/io/IOException; {:try_start_f0 .. :try_end_f4} :catch_81
.end method
...
.method public GetInputValues(Ljava/lang/String;)Ljava/util/List;
    ...
    :try_end_11
    .catch Ljava/lang/IllegalArgumentException; {:try_start_e .. :try_end_11} :catch_82
...
.method public GetOutputState(Ljava/lang/String;)Ljava/util/List;
    ...
    :try_end_11
    .catch Ljava/lang/IllegalArgumentException; {:try_start_e .. :try_end_11} :catch_90
...
.method public LsRead(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1}, Lcom/google/appinventor/components/runtime/NxtDirectCommands;->convertSensorPortLetterToNumber(Ljava/lang/String;)I
    :try_end_11
    .catch Ljava/lang/IllegalArgumentException; {:try_start_e .. :try_end_11} :catch_35
...
.method public LsWrite(Ljava/lang/String;Lcom/google/appinventor/components/runtime/util/YailList;I)V
    ...
    :try_end_c
    .catch Ljava/lang/IllegalArgumentException; {:try_start_9 .. :try_end_c} :catch_20
    ...
    :try_end_47
    .catch Ljava/lang/NumberFormatException; {:try_start_40 .. :try_end_47} :catch_68
...
.method public ResetInputScaledValue(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/appinventor/components/runtime/NxtDirectCommands;->convertSensorPortLetterToNumber(Ljava/lang/String;)I
    :try_end_e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_b .. :try_end_e} :catch_25
...
.method public ResetMotorPosition(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/appinventor/components/runtime/NxtDirectCommands;->convertMotorPortLetterToNumber(Ljava/lang/String;)I
    :try_end_e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_b .. :try_end_e} :catch_26
...
.method public SetOutputState(Ljava/lang/String;IIIIIJ)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/appinventor/components/runtime/NxtDirectCommands;->convertMotorPortLetterToNumber(Ljava/lang/String;)I
    :try_end_c
    .catch Ljava/lang/IllegalArgumentException; {:try_start_9 .. :try_end_c} :catch_21
