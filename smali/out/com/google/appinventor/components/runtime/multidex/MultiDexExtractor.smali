...
.method private static extract(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    :try_end_3a
    .catchall {:try_start_2b .. :try_end_3a} :catchall_d1
    ...
    throw v7
    :try_end_b8
    .catchall {:try_start_62 .. :try_end_b8} :catchall_b8
    ...
    throw v7
    :try_end_c8
    .catchall {:try_start_c4 .. :try_end_c8} :catchall_b8
...
.method private static performExtractions(Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    :try_end_f0
    .catchall {:try_start_25 .. :try_end_f0} :catchall_f1
    ...
    :try_end_f5
    .catch Ljava/io/IOException; {:try_start_f2 .. :try_end_f5} :catch_156
    ...
    invoke-virtual {v0, v10}, Ljava/util/zip/ZipFile;->getEntry(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
    :try_end_146
    .catchall {:try_start_f6 .. :try_end_146} :catchall_f1
...
.method static verifyZipFile(Ljava/io/File;)Z
    ...
    :try_end_5
    .catch Ljava/util/zip/ZipException; {:try_start_0 .. :try_end_5} :catch_29
    ...
    .catch Ljava/util/zip/ZipException; {:try_start_5 .. :try_end_8} :catch_29
    ...
    invoke-static {v3, v4}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_27
    .catch Ljava/util/zip/ZipException; {:try_start_b .. :try_end_27} :catch_29
    .catch Ljava/io/IOException; {:try_start_b .. :try_end_27} :catch_4d
